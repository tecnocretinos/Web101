console.log("Welcome to the class of classes")

class Estudiante {
    constructor(id, nombre, fechaNacimiento, listaNotas) {
        this.id = id
        this.nombre = nombre
    ...
    log() {
        return `El estudiante ${this.nombre} tiene un promedio de calificaciones de: ${this.promedioNotas()}`
    }
}

const tiago = new Estudiante(1, "Tiago Moreno", new Date(), [5, 4, 3, 2, 1])
console.log(tiago.log())
...
function mapaAEstudiante(map) {
    return new Estudiante(map.id, map.name, map.weight, map.stats)
}

console.log(mapaAEstudiante(pokemon))